...
_prompt_color="33m"  # yellow for host
case "$(hostname)" in
	red) _prompt_color="31m";;
	green) _prompt_color="32m";;
	blue) _prompt_color="34m";;
esac
...
# fancy prompt
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;'"$_prompt_color"'\]\u@\h:\[\033[00;'"$_prompt_color"'\]\w\$\[\033[00m\] '
